(function(){
    ...
    var codedCharacterSet = b.CodedCharacterSet["JIS X 0208:1983"] = new b.CodedCharacterSet();
    codedCharacterSet.CodePoint = u.inherits(function(){
        ...
        if(arguments.length == 2 && u.isUInt(arguments[0]) && u.isUInt(arguments[1])){
            ...
            if(!(1 <= row && row <= 94)) throw new Error(b.ErrorMessage.outOfRange("row"));
            if(!(1 <= cell && cell <= 94)) throw new Error(b.ErrorMessage.outOfRange("cell"));
            if(!(
                row == 1 ||
                row == 2 && (
                    1 <= cell && cell <= 14 ||
